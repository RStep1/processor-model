...
- Ячейка `0` содержит команду безусловного перехода на секцию `.text`
...
- Машинное слово - 4 байта. Операции с памятью осуществляются только при помощи абсолютной адресации.
